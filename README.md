...
<h3 align="center">AI Tools Library Platform</h3>
...
A Next.js 15 platform where users can submit and discover AI tools for various purposes, browse categories, and find the best AI solutions through a clean minimalistic design for a smooth user experience.
...
👉 **Live Content API**: Displays the latest AI tools dynamically on the homepage using Sanity's Content API.

👉 **GitHub Authentication**: Allows users to log in easily using their GitHub account.

👉 **AI Tool Submission**: Users can submit AI tools, including title, description, category, website link, and type (Free/Paid/Credit-based).
...
👉 **Profile Page**: Users can view the list of AI tools they've submitted.
...
👉 **Admin Dashboard**: Manage pending/approved AI tools and user statistics.

👉 **Modern UI/UX**: Smooth animations, gradients, and responsive design with Framer Motion and Tailwind CSS.
